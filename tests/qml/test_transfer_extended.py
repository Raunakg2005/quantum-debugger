...
from quantum_debugger.qml.transfer.serialization import (
    get_model_size,
    get_model_size_mb,
)
...
class TestFineTuningAdvanced:
    ...
    def test_fine_tune_improves_accuracy(self):
        ...
        # Fine-tune
        history = fine_tune_model(model, X_train, y_train, epochs=5, verbose=False)
    ...
    def test_fine_tune_with_validation(self):
        ...
        history = fine_tune_model(
            model, X_train, y_train, X_val=X_val, y_val=y_val, epochs=3, verbose=False
        )
