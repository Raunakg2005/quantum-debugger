...
class TestNoiseModels:
    ...
    def test_composite_noise_apply(self):
        ...
        noise = CompositeNoise([DepolarizingNoise(0.01), AmplitudeDampingNoise(0.02)])
    ...
    def test_create_realistic_noise_model(self):
        ...
        noise = create_realistic_noise_model(
            gate_error_rate=0.005, t1_time=100.0, t2_time=70.0, gate_time=0.05
        )
...
class TestPEC:
    ...
    def test_estimate_sampling_overhead(self):
        ...
        pec = PEC()
        overhead = pec.estimate_sampling_overhead(circuit_depth=10, avg_error_rate=0.01)
    ...
    def test_apply_pec(self):
        ...
        result, uncertainty = pec.apply_pec(
            mock_circuit, np.array([0.1, 0.2]), n_samples=10
        )
...
class TestErrorCharacterization:
    ...
    def test_characterize_readout_error(self):
        ...
        confusion = characterize_readout_error(
            n_qubits=1, executor=mock_executor, n_shots=1000
        )
