...
class TestMemoryUsage:
    ...
    def test_matrix_memory_reuse(self):
        ...
        gates_in_memory = sum(1 for obj in gc.get_objects() if isinstance(obj, RXGate))
...
class TestGarbageCollection:
    ...
    def test_gate_cleanup(self):
        ...
        # Get initial count
        initial_count = sum(
            1 for obj in gc.get_objects() if isinstance(obj, (RXGate, RYGate, RZGate))
        )
...
class TestLargeScale:
    ...
    def test_thousand_concurrent_gates(self):
        ...
        gates = [RXGate(target=i % 100, parameter=i * 0.001) for i in range(1000)]
...
class TestMemoryBenchmark:
    ...
    def test_memory_per_gate(self):
        ...
        # Create 1000 gates
        gates = [RXGate(target=i % 10, parameter=i * 0.1) for i in range(1000)]
