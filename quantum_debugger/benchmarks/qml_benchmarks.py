...
def benchmark_qnn(
    n_qubits: int, n_layers: int, dataset_size: int, epochs: int = 10
) -> Dict:
    """
...
def benchmark_qsvm(
    n_qubits: int, dataset_size: int, kernel_type: str = "fidelity"
) -> Dict:
    """
...
def compare_with_classical(
    n_qubits: int, dataset_size: int, task: str = "classification"
) -> Dict:
    """
    ...
    return {
        "qnn": {"train_time": qnn_train_time, "accuracy": qnn_accuracy},
        "classical": {"train_time": mlp_train_time, "accuracy": mlp_accuracy},
        "speedup": speedup,
...
def benchmark_suite(quick: bool = False) -> Dict:
    """
    ...
    """
    if quick:
        configs = [(2, 2, 50), (4, 3, 50)]
    else:
        configs = [(2, 2, 100), (4, 3, 100), (6, 4, 100)]
