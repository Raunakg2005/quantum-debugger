...
def benchmark_optimization(circuit_gates: List, optimization_level: int = 2) -> Dict:
    """
...
def benchmark_transpilation(circuit_gates: List, topology: Dict) -> Dict:
    """
...
def measure_speedup(
    n_qubits_range: List[int], optimization_levels: List[int] = [0, 1, 2, 3]
) -> Dict:
    """
