...
if __name__ == "__main__":
    print("\n" + "="*70)
    print(" " * 10 + "PERFORMANCE & ADVANCED PROPERTY TESTS")
    print("="*70)
    
    tests = [
        test_performance_benchmarks,
        test_memory_efficiency,
        test_channel_fidelity_bounds,
        test_entanglement_decay_rates,
        test_noise_invariants,
        test_noise_scaling,
        test_different_initial_states,
        test_noise_reversibility_impossible,
        test_statistical_properties,
        test_comparative_noise_effects,
        test_multi_step_error_accumulation,
    ...
    print("="*70)
    print(f"   Previous tests:     46/46 ✅")
    print(f"   Performance tests:  {passed}/12")
    print(f"   ───────────────────────────")
    print(f"   GRAND TOTAL:        {46 + passed}/58")
    print("="*70 + "\n")
